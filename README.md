...
| **Deck templates** | install one from a marketplace, then take the slides you want from it into the deck you already have — `Insert from a template…`, after the slide you are on, one undo entry | [SPEC MARKETPLACE_REGISTRY](SPEC.md#marketplace_registry--marketplaces-registered-not-fetched) |
