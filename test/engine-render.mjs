...
let bad = 0;
for (const mode of ['themepicker', 'palette', 'exclusive', 'restore', 'added', 'browse', 'nobrowse', 'wizard', 'contextmenu', 'commit', 'narration', 'nonarration', 'panel', 'hidden', 'hidden&all', 'exportpptx', 'exportfail']) {
  const r = resultsFrom(
