...
decklight/
  ...
  tools/         voiceover.mjs (batch TTS) + voiceover-server.mjs (tts bridge), tts-engines.mjs (gemini/chirp/piper/elevenlabs) + gemini-tts.mjs, elevenlabs-tts.mjs, lipsync.mjs (batch visemes/video) + lipsync-server.mjs (lipsync bridge), visemes.mjs (timeline v1), video.mjs (deck → narrated mp4, §8)
