...
export function init(userConfig = {}) {
  ...
  // it only matters if two overlays are somehow up at once. A feature that has
  // moved to its own module registers there instead — the theme picker (first,
  // registered by createThemes above) is the one that has.
  overlays.register({
    isOpen: () => !!palEl,
    close: closePalette,
    keydown(e) {
